CREATE TABLE config.gl_account_aud
(
...
ALTER TABLE config.gl_account_aud
...
CREATE TABLE config.gl_account_description_aud
(
    revision_id     bigint   NOT NULL,
    revision_end_id bigint,
    rev_type        smallint NOT NULL,
...
ALTER TABLE config.gl_account_description_aud
...
CREATE TABLE config.gl_account_part_aud
(
    revision_id                 bigint   NOT NULL,
    revision_end_id             bigint,
    rev_type                    smallint NOT NULL,
...
ALTER TABLE config.gl_account_part_aud
...
CREATE TABLE config.gl_account_part_description_aud
(
    revision_id        bigint   NOT NULL,
    revision_end_id    bigint,
    rev_type           smallint NOT NULL,
...
ALTER TABLE config.gl_account_part_description_aud
