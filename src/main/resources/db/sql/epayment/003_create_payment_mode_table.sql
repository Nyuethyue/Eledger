...
CREATE SEQUENCE payment_mode_id_seq
    INCREMENT BY 1
    MINVALUE 1
    START 1
    CACHE 1
    NO CYCLE
    OWNED BY payment_mode.id;
------------------------------------------------------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS payment_mode_description
(
    id              bigint  NOT NULL,
...
ALTER TABLE payment_mode_description
...
CREATE INDEX IF NOT EXISTS fki_payment_mode_description_payment_mode
    ON payment_mode_description (payment_mode_id);

CREATE SEQUENCE payment_mode_description_id_seq
    INCREMENT BY 1
    MINVALUE 1
    CACHE 1
    NO CYCLE
    OWNED BY payment_mode_description.id;
