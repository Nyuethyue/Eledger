...
@RestController
@RequestMapping("/config/balance/account/part/history")
@RequiredArgsConstructor
class BalanceAccountPartHistoryController {
    private final GetBalanceAccountPartHistoryUseCase getBalanceAccountPartHistoryUseCase;
    ...
    @Data
    private static class BalanceAccountPartHistoryPresentation {
