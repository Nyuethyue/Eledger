...
@Entity
@Table(name = "gl_account_part_type", schema = "config")
@NoArgsConstructor
class GLAccountPartTypeEntity {

    @Id
    @SequenceGenerator(name = "gl_account_part_type_id_seq", schema = "config", sequenceName = "gl_account_part_type_id_seq", allocationSize = 1)
