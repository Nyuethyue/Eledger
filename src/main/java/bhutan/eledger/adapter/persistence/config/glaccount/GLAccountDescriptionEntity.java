...
@Table(name = "gl_account_description", schema = "config")
@NoArgsConstructor
class GLAccountDescriptionEntity extends TranslationEntity {
    @Id
    @SequenceGenerator(name = "gl_account_description_id_seq", schema = "config", sequenceName = "gl_account_description_id_seq", allocationSize = 1)
