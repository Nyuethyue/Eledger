...
@Entity
@Audited
@Table(name = "gl_account_part", schema = "config")
@NoArgsConstructor
class GLAccountPartEntity {
    @Id
    @SequenceGenerator(name = "gl_account_part_id_seq", schema = "config", sequenceName = "gl_account_part_id_seq", allocationSize = 1)
