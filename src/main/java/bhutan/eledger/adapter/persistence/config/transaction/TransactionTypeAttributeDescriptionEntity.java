...
@Entity
@Table(name = "transaction_type_attribute_description", schema = "config")
@NoArgsConstructor
class TransactionTypeAttributeDescriptionEntity extends TranslationEntity {
    @Id
    @SequenceGenerator(name = "transaction_type_attribute_description_id_seq", schema = "config", sequenceName = "transaction_type_attribute_description_id_seq", allocationSize = 1)
