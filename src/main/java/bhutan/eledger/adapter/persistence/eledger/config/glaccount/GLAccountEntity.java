...
@Entity
@Audited
@Table(name = "gl_account", schema = "eledger_config")
@AllArgsConstructor
@NoArgsConstructor
class GLAccountEntity {
    @Id
    @SequenceGenerator(name = "gl_account_id_seq", schema = "eledger_config", sequenceName = "gl_account_id_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "gl_account_id_seq")
    @Column(name = "id")
    private Long id;
