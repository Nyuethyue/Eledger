...
@Getter
@Validated
public class ReconciliationRecordHistorySearchProperties extends AbstractSearchProperties {
    public ReconciliationRecordHistorySearchProperties(int page, int size, String sortProperty, String sortDirection, Collection<String> availableSortProperties) {
        super(
                page,
                size,
                sortProperty,
